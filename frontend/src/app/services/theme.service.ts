...
export class ThemeService {
  ...
  private _darkThemeActive = new ReplaySubject<boolean>(1);
  public darkThemeActive$ = this._darkThemeActive.asObservable();

  constructor(private rendererFactory: RendererFactory2) {
    this.renderer = this.rendererFactory.createRenderer(null, null);
    this.activeTheme = AvailableThemes.dark;
    this._darkThemeActive.next(true);
  }
  ...
  public enableTheme(theme: AvailableThemes): void {
    ...
    switch(theme) {
      case AvailableThemes.light:
        ...
        this._darkThemeActive.next(false);
        break;
